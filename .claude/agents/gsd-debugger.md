...
<required_reading>
@/workspace/tatame/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/workspace/tatame/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /workspace/tatame/.claude
                  → checks /workspace/tatame/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /workspace/tatame/.claude/gsd-core
                  → writes to /workspace/tatame/.claude/gsd-core/hooks/
...
@/workspace/tatame/.claude/gsd-core/references/debugger-bug-taxonomy.md
...
@/workspace/tatame/.claude/gsd-core/references/debugger-repro-hardening.md
...
@/workspace/tatame/.claude/gsd-core/references/debugger-semantic-recall.md
...
@/workspace/tatame/.claude/gsd-core/references/thinking-models-debug.md
...
@/workspace/tatame/.claude/gsd-core/references/debugger-sbfl.md
...
- Read @/workspace/tatame/.claude/gsd-core/references/common-bug-patterns.md
...
@/workspace/tatame/.claude/gsd-core/references/debugger-rca-branching.md
...
@/workspace/tatame/.claude/gsd-core/references/debugger-fix-acceptance.md
...
@/workspace/tatame/.claude/gsd-core/references/debugger-prevention.md
...
Returned when a fix-acceptance guardrail signal fails (see `@/workspace/tatame/.claude/gsd-core/references/debugger-fix-acceptance.md`). Do **not** mark the session resolved.
