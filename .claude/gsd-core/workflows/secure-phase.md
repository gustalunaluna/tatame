...
```
Agent(
  prompt="Read /workspace/tatame/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/workspace/tatame/.claude/gsd-core/templates/SECURITY.md`
