...
<required_reading>
@/workspace/tatame/.claude/gsd-core/references/ai-frameworks.md
@/workspace/tatame/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /workspace/tatame/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/workspace/tatame/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /workspace/tatame/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /workspace/tatame/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /workspace/tatame/.claude/agents/gsd-eval-planner.md for instructions.
