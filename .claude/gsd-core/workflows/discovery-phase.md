...
See /workspace/tatame/.claude/gsd-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /workspace/tatame/.claude/gsd-core/templates/discovery.md structure:
...
1. **Scope the discovery** using /workspace/tatame/.claude/gsd-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /workspace/tatame/.claude/gsd-core/templates/discovery.md
...
Use /workspace/tatame/.claude/gsd-core/templates/discovery.md.
