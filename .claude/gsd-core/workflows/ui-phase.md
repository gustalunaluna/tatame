...
```markdown
Read /workspace/tatame/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /workspace/tatame/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /workspace/tatame/.claude/agents/gsd-ui-checker.md for instructions.
...
@/workspace/tatame/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /workspace/tatame/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/workspace/tatame/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/workspace/tatame/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
