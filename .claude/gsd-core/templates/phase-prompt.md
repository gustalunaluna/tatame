...
<!-- For checkpoint task examples and patterns, see @/workspace/tatame/.claude/gsd-core/references/checkpoints.md -->
...
See `/workspace/tatame/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/workspace/tatame/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/workspace/tatame/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
