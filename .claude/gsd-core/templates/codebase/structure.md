...
- Usage: Reference from command with `@/workspace/tatame/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /workspace/tatame/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /workspace/tatame/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
