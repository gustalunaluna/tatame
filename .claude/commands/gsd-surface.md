...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/workspace/tatame/.claude/.gsd-surface.json`
(sibling to `/workspace/tatame/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/workspace/tatame/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/workspace/tatame/.claude/skills`).
...
`/workspace/tatame/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/workspace/tatame/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/workspace/tatame/.claude/.gsd-surface.json`
Install profile marker: `/workspace/tatame/.claude/.gsd-profile`
Skill dirs: `/workspace/tatame/.claude/skills/gsd-*/`
Engine module: `/workspace/tatame/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/workspace/tatame/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
