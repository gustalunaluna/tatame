-- ============================================================
-- TATAME — Conquistas + Meus dados (ARQUIVO ÚNICO)
-- Rode DEPOIS de: 1) rodar 001_schema.sql  2) criar sua conta no app
-- Equivale a rodar 002 e 003 em sequência. Seguro rodar mais de uma vez.
-- ============================================================
