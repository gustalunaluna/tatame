...
const telas = ["/", "/jiu-jitsu", "/dieta", "/dieta/cardapio", "/dieta/peso", "/dieta/ajustes", "/diario", "/tecnicas", "/analises", "/plano", "/metas", "/conquistas", "/parceiros", "/equipe", "/perfil", "/minhas-medalhas", "/minhas-graduacoes"];
const resultado = [];
