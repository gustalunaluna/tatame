...
const telas = ["/", "/jiu-jitsu", "/dieta", "/dieta/peso", "/dieta/ajustes", "/diario", "/tecnicas", "/analises", "/plano", "/metas", "/conquistas", "/parceiros", "/equipe", "/perfil", "/minhas-medalhas", "/minhas-graduacoes"];
const resultado = [];
